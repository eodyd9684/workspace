...
SELECT ORDER_NUM, ORDER_ITEM, ORDER_CNT, ORDER_USER_ID, O.PAY_NUM, P.PAY_NUM, PAY_PRICE, PAY_DATE
...
SELECT ORDER_ITEM, ORDER_CNT, PAY_PRICE, PAY_TYPE, PAY_DATE
FROM order_info O INNER JOIN pay_info P
ON o.PAY_NUM = p.PAY_NUM
WHERE PAY_TYPE = '계좌이체' 
AND PAY_PRICE > 10000 
