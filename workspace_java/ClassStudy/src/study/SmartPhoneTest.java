...
public class SmartPhoneTest {
  public static void main(String[] args) {
    ...
    SmartPhone p2 = new SmartPhone("s2", 11000, 13.5);
    SmartPhone p3 = new SmartPhone("s3", 12000, 14.5);
    SmartPhone p4 = new SmartPhone("s4", 13000, 15.5);
    SmartPhone p5 = new SmartPhone("s5", 14000, 16.5);
